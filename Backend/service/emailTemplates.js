function OTPEmail({ name, otp, email }) {
    return (
        ...
        <body>
        <!--Subject: Account Verification Required for Your Odoo Account-->
            <div class="container">
                <div class="header">
                ...
                <p>
                    We have received a request for your Odoo account. For
                ...
                <p style="font-size: 0.9em">
                    ...
                    <br />
                    <br />
                    <strong>Thank you for using Odoo.</strong>
                    <br />
                    <br />
                    Best regards,
                    <br />
                ...
                <div class="footer" style="text-align: center">
                    ...
                    <p>
                    For more information about Odoo and your account, visit
                    <strong>Odoo.in</strong>
                    </p>
                </div>
            </div>
            <div style="text-align: center">
                ...
                <div class="email-info">
                    <a href="Odoo.in">Odoo.in</a> | Panjab University
                    | Chandigarh - 160014, India
                </div>
                <div class="email-info">
                    &copy; 2025 Odoo. All rights
                    reserved.
                </div>
            </div>
        </body>
